...
import { ResetPassword, Role, User } from "../../prisma/PostgreSQL/generated/client";
import * as supertest from "supertest";

describe('Reset-passwords', () => {
    const gDto = new GeneratorDto('rpass');
